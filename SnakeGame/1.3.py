...
while running:
    ...
    # Check for collision with apple, By using magical math to check if one side of the snake makes contact with one side of the apple
    # Im going to be honest this was done by ChatGPT, im just trying to figure out what it means and how it works.
    if (
        snake_x < apple_x + 10 # EX: 15 < 25 + 10
        and snake_x + 20 > apple_x # This checks if the right side of the snake(snake_x + 20) is to the right of the left side of the apple(apple_x + 10) (plus a little buffer of 10 units).
    ...
    # The variable snake_x represents the x-coordinate of the snake's head.
    # The value 20 represents the width of the snake.
    # The variable apple_x represents the x-coordinate of the apple.
    
        #Now an example

    # If the x-coordinate of the snake's head (snake_x) .... is 30 .... and the width of the snake is 20.
    # Then the right side of the snake is at ..... 30  +  20  =  50
    
    # If the x cordinate of the applee (apple_x) is 40.
    #it means the left side of the apple is at 40x
        
    #The condition snake_x + 20 > apple_x   (at apple_x).
    # Is checking if the right side of the snake (snake_x + 20)
    # Is to the right of the left side of the apple,  If the right side of the snake is indeed here
    # the condition evaluates to True.
        
    #Being Honest Im Still not 100% sure about understanding this but i have a headache so yeahh byee..
        
    #1 hour later I DID IT I FIGURED IT OUT BY MYSELF YESSSS, Voy a escribir esto en spanol porque es mi primer lenguaje y asi lo escribi en una hoja de papel
