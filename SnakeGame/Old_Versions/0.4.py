...
#IM 90% SURE I NEED TO REWRTIE ALL OF THIS AHHHHHH
# Well that why it is version 0 and not version 1
...
pygame.display.set_caption("GSnake Game 0.4") #Name of the window
