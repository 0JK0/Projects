...
pygame.display.set_caption("Snake Game v1.4")# not alot of differences between versions,altough im a workaholic but since im just learning everything takes a looong while
