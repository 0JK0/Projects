...
while running:
    ...
    elif last_key == pygame.K_BACKSPACE: snake_body.append(snake_body[-1])
    elif last_key == pygame.K_SPACE:  dire [1] += 1
    ...
    screen.blit(background_image, (0, 0))
    reload_text = font2.render("Press R to reload", True, black)
